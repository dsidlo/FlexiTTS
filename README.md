...
## Scripts
  ...
  - chapter_to_xml.py
    ...
    - Uses the [FlexiTTS-AI-Prompt-Chapter-to-XML.md](https://github.com/dsidlo/FlexiTTS/FlexiTTS/main/FlexiTTS-AI-Prompt-Chapter-to-XML.md) to generate an XML file that augments the original Markdown chapter with tags indicating dialogs for the Narrator and other Characters along with emotional attributes for each character.
